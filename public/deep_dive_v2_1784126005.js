...
function renderDrawer(key) {
  ...
  /* Row 1: [badge + github] on left, [toolbar] on right */
  ...
  var titleRow = '<div class="brief-hdr-titles">' +
    ...
    (p.github ? '<a class="brief-github-btn" href="' + p.github + '" target="_blank" rel="noopener noreferrer" aria-label="View on GitHub" style="margin-top:6px;display:none;" onclick="var w=window.open(this.href,\"_blank\",\"noopener,noreferrer\");if(!w){try{window.top.location.href=this.href;}catch(e){}}return false;">' + githubSvg + '<span class="brief-github-label">View on GitHub</span></a>' : '') +
  '</div>';
