...
function renderDrawer(key) {
  ...
  bottomBar.innerHTML =
    ...
    '<button id="dd-theme-toggle" onclick="toggleDDTheme()" aria-label="Toggle light / dark" title="Toggle reading mode"><span id="dd-theme-icon">&#9790;</span> Mode</button>';
