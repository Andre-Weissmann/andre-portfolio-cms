...
function renderDrawer(key) {
  ...
  /* GitHub icon rendered as 💻 emoji to match the sun / moon theme-toggle style. */
  var githubSvg = '<span class="brief-github-icon dd-theme-emoji" aria-hidden="true">💻</span>';
    ...
    '<div class="brief-hdr-content">' +
      '<div class="brief-hdr-top-row">' +
        ...
        '<div class="brief-hdr-tools">' +
          (p.github ? '<a class="brief-tool-btn brief-github-btn" href="' + p.github + '" target="_blank" rel="noopener noreferrer" aria-label="Code on GitHub" title="Code on GitHub (leaves page)">' + githubSvg + '</a>' : '') +
