...
/* ─── CMS QUALITY + FEDERAL IDR (PROJECT ALPHA) ─── */
cmsQualityIdr: {
  badge: 'SQL + Python',
  badgeColor: '#0F766E',
  ...
  kpis: [
    ...
    { label: 'EPO avg overall (NR out)', value: 3.24, icon: '⭐' },
    { label: 'IDR provider win Q2', value: 88.2, suffix: '%', icon: '⚖️' },
...
function renderDrawer(key) {
  ...
  /* Official GitHub Invertocat mark from https://github.com/logos (brand-toolkit source). */
  var githubSvg = '<svg class="brief-github-icon" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 0C5.374 0 0 5.374 0 12c0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23A11.509 11.509 0 0 1 12 5.803c1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576C20.566 21.797 24 17.3 24 12c0-6.627-5.373-12-12-12z"/></svg>';
    ...
    '<div class="brief-hdr-content">' +
      '<div class="brief-hdr-top-row">' +
        ...
        '<div class="brief-hdr-tools">' +
          (p.github ? '<a class="brief-tool-btn brief-github-btn" href="' + p.github + '" target="_blank" rel="noopener noreferrer" aria-label="GitHub" title="GitHub (leaves page)">' + githubSvg + '<span class="brief-github-label">GitHub</span></a>' : '') +
  ...
  if (p.context) {
    ...
    var ASK_QA = {
      ...
      cmsQualityIdr: [
        { label: 'Main finding', a: 'Three defensible results on current CMS public files. (1) After excluding Not Rated, EPO leads Marketplace plan types on average overall stars at 3.24 (n=922 rated plans), ahead of HMO, POS, and PPO. (2) Federal IDR provider-prevailing share moved from 87.4% in 2025 Q1 to 88.2% in Q2 across hundreds of thousands of payment determinations. (3) Among plans with both Overall and Plan Administration rated, Admin is at least one full star above Overall 48.8% of the time (1,531 of 3,139).' },
        { label: 'How this helps healthcare', a: 'It turns noisy public CMS tables into decision inputs quality, network, and payment teams can use in real meetings. Honest NR rules stop fake low star rankings. Separate Quality vs IDR grains stop false joins that invent relationships. IDR win-rate and initiating concentration give payment and network leads a current read on dispute dynamics. Admin vs Overall gaps flag where administrative experience may look stronger than the blended quality story members and regulators see.' },
        { label: 'Educates and informs experts', a: 'For people new to these files: it teaches what each source measures (Marketplace plan stars vs Federal IDR payment determinations), why Not Rated cannot be averaged as zero, and why plan-year quality cannot be joined to dispute tables without lying about grain. For people who already know CMS quality and IDR: it is a reproducible benchmark on current cuts (PY2026 Quality PUF; 2025 Q1-Q2 IDR), dual-engine checked in SQL and Python, with explicit filters (initiating-only for concentration) so experts can challenge n, definitions, and deltas instead of debating vibes.' },
        { label: 'What the data shows', a: 'Quality PUF PY2026: 4,302 plan rows. Overall is NR or empty on about 27% of plans; Member Experience is NR-heavy (about 55%). Rated plan-type averages (NR excluded): EPO 3.24, HMO 3.18, POS 3.09, PPO 3.05. IDR: provider prevailing 87.4% (Q1) and 88.2% (Q2). After filtering to initiating parties, top three (HaloMD, Team Health, SCP Health) account for roughly 46% of listed OON items/services vs about 54% for the rest of the field.' },
        { label: 'Tools used', a: 'SQL and Python on the same public CMS downloads (dual-engine check). Definitions locked before aggregates: NR/blank/Not Rated excluded from star means; Quality and IDR kept on separate grains; initiating-role filter before concentration shares. DataGlow used as the local-first workbench path to load the Quality PUF and walk clean / ask / prove. Portfolio deep dive shows re-runnable SQL lenses, charts, and the analysis trail.' },
        { label: 'Limitation', a: 'Public CMS files only. IDR figures are supplemental aggregates, not claim-line microdata, so this informs strategy and monitoring rather than adjudicating a single case. No HIPAA certification claim and no private claims data. Results support better questions and better-defined KPIs; they do not by themselves implement a plan design change or payment policy. Experts should re-run with updated CMS releases as tables refresh.' }
      ]
    };
